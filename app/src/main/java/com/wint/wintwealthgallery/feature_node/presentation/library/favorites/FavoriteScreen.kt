...
package com.wint.wintwealthgallery.feature_node.presentation.library.favorites
...
import com.wint.wintwealthgallery.feature_node.presentation.library.favorites.components.EmptyFavorites
...
fun FavoriteScreen(
    ...
    var title = if (selectionState.value) removeSelectedTitle else removeAllTitle
    LaunchedEffect(selectionState) {
        title = if (selectionState.value) removeSelectedTitle else removeAllTitle
    }
                                    ...
                                    if (selectionState.value) {
                                        ...
                                        navController.navigate(
                                            Screen.MediaViewScreen.route +
                                                    "?mediaId=${it.id}&target=favorites"
                                        )
                                    }
                                }
                            )
